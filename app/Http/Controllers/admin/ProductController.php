...
class ProductController extends Controller
{
    ...
    public function item_create(){
        ...
        return view('admin.product.addItem')->with([
            'categorys' => $categorys,
            'units' => $units,
            'suppliers' => $supplier
        ]);
    ...
    public function item_store(Request $request){
        ...
        try{
            ...
            $this->barcode($ean_13);
            DB::commit();
            return redirect()->route('admin.product.index')->with('success', 'data item berhasil di tambahkan');
        }catch(Exception $e){
            DB::rollBack();
    ...
    public function item_show($id){
        ...
        $units = Unit::all();
        return view('admin.product.editItem')->with([
            'categorys' => $categorys,
            'suppliers' => $suppliers,
            'units' => $units,
            'item' => $item
    ...
    public function item_edit(Request $request,$id){
        ...
        try{
            ...
            DB::commit();
            return redirect()->route('admin.product.index')->with('success','data item berhsail di update');
        }catch(Exception $e){
            DB::rollBack();
            return back()->with('error',$e->getMessage());
        }
