        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.transaction.order.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control">RP. <div class="d-inline-block jumlah-bayar" id="jumlah-bayar">0</div></div>
                        </div>
                        <div class="form-group">
    ...
    $(document).on('click','#add-new-order',function(){
        ...
        $.ajax({
            ...
            success : function(result){
                ...
                $('#stock').val('');
                $('#jumlah-bayar').unmask();
                $('#jumlah-bayar').html(harga_sesudah);
                $('#jumlah-bayar').mask('000.000.000.000', {reverse: true});
                $('#nama-item').val('');
                $('#stock-pertama').val('');
                $('#price-item').val('');
