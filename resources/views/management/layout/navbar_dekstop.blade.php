                    ...
                    <div class="noti-wrap">
                        ...
                        <div class="noti__item js-item-menu">
                            ...
                            <div class="notifi-dropdown js-dropdown">
                                ...
                                <a href="{{ route('management.transaction.stockIn.index') }}#item{{ $barang_expire->id }}" class="{{ $barang_expire->bg_alert }}">
                                ...
                                <a href="{{ route('management.transaction.stockRetur.index') }}">
                                    <div class="notifi__item">
                                        <div class="bg-c3 img-cir img-40">
                                            <i class="zmdi zmdi-file-text"></i>
                                        </div>
