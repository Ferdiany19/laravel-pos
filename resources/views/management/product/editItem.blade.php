    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('management.item.edit',$item->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="name" class="control-label mb-1">Name</label>
                        <input id="name" name="name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $item->name }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="warning_expire" id="warning_expire" class="form-control" placeholder="misal nya 7, maksudnya 7 hari lagi akan kadaluarsa" value="{{ $item->warning_expire ?? '' }}">
                    </div>
                    <div class="form-group row">
                        <div class="form-group col-lg-4">
                            <label for="price" class="control-label mb-1">Price</label>
                            <input id="price" name="price" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $item->price }}">
                        </div>
                        <div class="form-group col-lg-4">
                            ...
                            <select name="methodStock" id="methodStock" class="form-control">
                                ...
                                <option value="fifo" {{ $item->method_stock == 'fifo' ? 'selected' : '' }}>fifo</option>
                                <option value="lifo" {{ $item->method_stock == 'lifo' ? 'selected' : '' }}>lifo</option>
                            </select>
                        </div>
                        <div class="form-group col-lg-4">
                            <div class=" col-12">
