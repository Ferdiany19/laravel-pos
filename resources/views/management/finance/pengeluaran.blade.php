...
@section('content')
    <div class="mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <select id="select-table" class="form-control mb-4">
                ...
                <div id="kumpulan-table">
                    <div id="table-pengeluaran">
                        <div class="mt-3 row">
                            <div class="col-md-6 mb-1">
                                <a class="btn btn-danger form-control" href="{{ route('management.finance.pengeluaran.pdf') }}" target="_blank">Export Pengeluaran PDF <i class="fas fa-file-pdf"></i></a>
                            </div>
                            <div class="col-md-6">
                                <a class="btn btn-success form-control" href="{{ route('management.finance.pengeluaran.excel') }}" target="_blank">Export Pengeluaran Excel <i class="fas fa-file-excel"></i></a>
                            </div>
                        </div>
                    ...
                    <div id="table-pemasukan"  style="display: none">
                        <div class="mt-3 row">
                            <div class="col-md-6 mb-1">
                                <a class="btn btn-danger form-control" href="{{ route('management.finance.pemasukan.pdf') }}" target="_blank">Export Pemasukan PDF <i class="fas fa-file-pdf"></i></a>
                            </div>
                            <div class="col-md-6">
                                <a class="btn btn-success form-control" href="{{ route('management.finance.pemasukan.excel') }}" target="_blank">Export Pemasukan Excel <i class="fas fa-file-excel"></i></a>
                            </div>
                        </div>
                        <div class="table-responsive table--no-card m-b-30">
                            <table class="table table-borderless table-striped table-earning">
                    ...
                    <div  id="table-laba" style="display: none">
                        <div class="mt-3 row">
                            <div class="col-md-6 mb-1">
                                <a class="btn btn-danger form-control" href="{{ route('management.finance.laba.pdf') }}" target="_blank">Export Laba PDF <i class="fas fa-file-pdf"></i></a>
                            </div>
                            <div class="col-md-6">
                                <a class="btn btn-success form-control" href="{{ route('management.finance.laba.excel') }}" target="_blank">Export Laba Excel <i class="fas fa-file-excel"></i></a>
                            </div>
                        </div>
                        <div class="table-responsive table--no-card m-b-30">
                            <table class="table table-borderless table-striped table-earning">
                    ...
                    <div id="table-belum-terjual" style="display: none">
                        <div class="mt-3 row">
                            <div class="col-md-6 mb-1">
                                <a class="btn btn-danger form-control" href="{{ route('management.finance.belum-terjual.pdf') }}" target="_blank">Export Belum Terjual PDF <i class="fas fa-file-pdf"></i></a>
                            </div>
                            <div class="col-md-6">
                                <a class="btn btn-success form-control" href="{{ route('management.finance.belum-terjual.excel') }}" target="_blank">Export Belum Terjual Excel <i class="fas fa-file-excel"></i></a>
                            </div>
                        </div>
                        <div class="table-responsive table--no-card m-b-30">
                            <table class="table table-borderless table-striped table-earning">
                    ...
                    <div id="table-retur-pemasukan" style="display: none">
                        <div class="mt-3 row">
                            <div class="col-md-6 mb-1">
                                <a class="btn btn-danger form-control" href="{{ route('management.finance.retur-pemasukan.pdf') }}" target="_blank">Export Retur Pemasukan PDF <i class="fas fa-file-pdf"></i></a>
                            </div>
                            <div class="col-md-6">
                                <a class="btn btn-success form-control" href="{{ route('management.finance.retur-pemasukan.excel') }}" target="_blank">Export Retur Pemasukan Excel <i class="fas fa-file-excel"></i></a>
                            </div>
                        </div>
                        <div class="table-responsive table--no-card m-b-30">
                            <table class="table table-borderless table-striped table-earning">
                    ...
                    <div id="table-retur-pengeluaran" style="display: none">
                        <div class="mt-3 row">
                            <div class="col-md-6 mb-1">
                                <a class="btn btn-danger form-control" href="{{ route('management.finance.retur-pengeluaran.pdf') }}" target="_blank">Export Retur Pengeluaran PDF <i class="fas fa-file-pdf"></i></a>
                            </div>
                            <div class="col-md-6">
                                <a class="btn btn-success form-control" href="{{ route('management.finance.retur-pengeluaran.excel') }}" target="_blank">Export Retur Pengeluaran Excel <i class="fas fa-file-excel"></i></a>
                            </div>
                        </div>
                        <div class="table-responsive table--no-card m-b-30">
                            <table class="table table-borderless table-striped table-earning">
